sp2 <- function(y1, y2, tol = 1e-6) {
  ...
  mod1 <- optimize( sp1, c(0, 1), r2 = 0.5, a1 = a1, a2 = a2, n1 = n1, n2 = n2, d = d,
                    maximum = TRUE, tol = 1e-6 )
  mod2 <- optimize( sp2, c(0, 1), r1 = mod1$maximum, a1 = a1, a2 = a2, n1 = n1, n2 = n2, d = d,
                    maximum = TRUE, tol = 1e-6 )
  lik1 <- mod2$objective
  r1 <- mod1$maximum
  r2 <- mod2$maximum
  ...
  mod1 <- optimize( sp1, c(0, 1), r2 = r2, a1 = a1, a2 = a2, n1 = n1, n2 = n2, d = d,
                    maximum = TRUE, tol = 1e-6 )
  mod2 <- optimize( sp2, c(0, 1), r1 = mod1$maximum, a1 = a1, a2 = a2, n1 = n1, n2 = n2, d = d,
                    maximum = TRUE, tol = 1e-6 )
  lik2 <- mod2$objective
  ...
  n <- n1 + n2
  list( mu = mu, rho1 = r1, rho2 = r2, loglik = lik2 + n * lgamma( 0.5 * (d + 1) ) - 
        0.5 * n * (d + 1) * log(pi) - n * log(2) )
}
